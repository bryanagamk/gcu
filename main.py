...
if __name__ == '__main__':
    ...
    # parameter penyakit
    params = ['sistole', 'diastole', 'kreatinin', 'gpr',
              'ureum', 'riwayat_merokok', 'riwayat_olahraga']
    ...
    level_status = util.get_level_status(
        params_scale, current_hipertensi_item, ref_data)
    print(level_status)
